...
void m3dc1_source::add_pcms_fields(fusion_io::Library lib) {
  ...
  // lib.client->AddField("rzero", FieldAdapter(&rzero));
  // lib.client->AddField("z_ion", FieldAdapter(&z_ion));
  // lib.client->AddField("ion_mass", FieldAdapter(&ion_mass));
  // lib.client->AddField("period", FieldAdapter(&period));
  // lib.client->AddField("n0", FieldAdapter(&n0));
  // lib.client->AddField("L0", FieldAdapter(&L0));
  // lib.client->AddField("B0", FieldAdapter(&B0));
  // lib.client->AddField("p0", FieldAdapter(&p0));
  // lib.client->AddField("t0", FieldAdapter(&t0));
  // lib.client->AddField("v0", FieldAdapter(&v0));
  // lib.client->AddField("J0", FieldAdapter(&J0));
  // lib.client->AddField("Phi0", FieldAdapter(&Phi0));
  // lib.client->AddField("temp0", FieldAdapter(&temp0));
  // lib.client->AddField("eta0", FieldAdapter(&eta0));
  // lib.client->AddField("linear", FieldAdapter(&linear));
  // lib.client->AddField("eqsubtract", FieldAdapter(&eqsubtract));
  // lib.client->AddField("extsubtract", FieldAdapter(&extsubtract));
  // lib.client->AddField("icomplex", FieldAdapter(&icomplex));
  // lib.client->AddField("i3d", FieldAdapter(&i3d));
  // lib.client->AddField("version", FieldAdapter(&version));
  // lib.client->AddField("itor", FieldAdapter(&itor));
  // lib.client->AddField("ntor", FieldAdapter(&ntor));
  // lib.client->AddField("ntime", FieldAdapter(&ntime));
  // lib.client->AddField("ifprime", FieldAdapter(&ifprime));
